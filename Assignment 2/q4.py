...
with open("out/3-to-2-ratio.csv", "w") as picsv:
    ...
    # lines.append(state_map[kys[1]] + "\n")
    # lines.append(state_map[kys[2]] + "\n")
    lines.append(str(int(kys[-1])//10) + str(int(kys[-1])%10) + "\n")
    lines.append(str(int(kys[-2])//10) + str(int(kys[-2])%10) + "\n")
    lines.append(str(int(kys[-3])//10) + str(int(kys[-3])%10) + "\n")
    lines.append(str(int(kys[0])//10) + str(int(kys[0])%10) + "\n")
    lines.append(str(int(kys[1])//10) + str(int(kys[1])%10) + "\n")
    lines.append(str(int(kys[2])//10) + str(int(kys[2])%10) + "\n")
